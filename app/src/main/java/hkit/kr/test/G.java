...
public class G {
    ...
    static String[] CHAR_NAMES = {"미사나 미코토", "시나 미나츠"};

    static String[] CHAR_HEIGHTS = {"161cm", "159cm"};

    static int[] CHAR_GENDERS = {G.WOMAN, G.WOMAN};

    static int[] CHAR_BLOODS = {G.AB, G.O};

    static int[] CHAR_HOROS = {G.TAURUS, G.VIRGO};

    static int[] CHAR_MONTHS = {5, 9};

    static int[] CHAR_DAYS = {2, 6};
